...
#to manage files
import configparser #for setting .ini file format for .json import json
import json #for save files with campain why json becouse i dont knwo what difrent file format use

def save(a, b):
    folder = "./data"
    file = os.path.join(folder, "save.json")

    if a == "load":
        #carte folder dir
        os.makedirs(folder, exist_ok=True)
        #crate json if dont exist
...
def ini():
    global boat_name, animation_speed_letter_d, animation_speed_letter_r, Dmode, debugingtime, errormsg, errorsmg_m, old_input_testers_dont_like_that, enemy_butiful
    ini_file = "settings.ini"
    if os.path.exists(ini_file):
        config = configparser.ConfigParser()
        config.read(ini_file)
        #settings
        if "animation_speed_letter_d" in config["settings"]:
            animation_speed_letter_d = config["settings"].get("animation_speed_letter_d")
            animation_speed_letter_d = float(animation_speed_letter_d)
        if "animation_speed_letter_r" in config["settings"]:
            animation_speed_letter_r = config["settings"].get("animation_speed_letter_r")
            animation_speed_letter_r = float(animation_speed_letter_r)
        if "old_input_testers_dont_like_that" in config["settings"]:
            old_input_testers_dont_like_that = config["settings"].getboolean("old_input_testers_dont_like_that")
        if "debugingtime" in config["settings"]:
            debugingtime = config["settings"].get("debugingtime")
            debugingtime = int(debugingtime)
        if "errormsg" in config["settings"]:
            errormsg = config["settings"].get("errormsg")
            errormsg = int(errormsg)
        if "errorsmg_m" in config["settings"]:
            errorsmg_m = config["settings"].get("errorsmg_m")
            errorsmg_m = int(errorsmg_m)
        #apperance
        if "boat_name" in config["apperance"]:
            boat_name = config["apperance"].get("boat_name")
        if "Dmode" in config["apperance"]:
            Dmode = config["apperance"].get("Dmode")
            Dmode = int(Dmode)
        if "enemy_butiful" in config["apperance"]:
            enemy_butiful = config["apperance"].get("enemy_butiful")
            enemy_butiful = int(enemy_butiful)
        #custom apperance
...
for i in range(26): #26 alfabeth characters in safe_list there is 26(25)
    spritepos.append(basic_sprite_pos) #you can customize this pls follow order of 7 character in this
...
def enemy_is_butyfil(a):
    global enemysprite, enemy_butiful
    enemy_butiful = a
                    ...
                    while True:
                        ...
                        if selec.upper() in sele1:
                            ...
                            while True:
                                cls()
                                print("")
                                print("Select enemy look".center(120))
                                print("")
                                print("1.Normal".center(120))
                                print("2.Square".center(120))
                                print("3.Tank".center(120))
                                print("4.Car".center(120))
                                print("5.Random - cooming soon".center(120))
                                print("To make custom go to tutorials".center(120))
                                print("0.Back".center(120))
                                sele1 = ["1.","1","NORMAL"]
                                sele2 = ["2.","2","SQUARE"]
                                sele3 = ["3.","3","TANK"]
...
def tutorials():
    while True:
        ...
        print("")
        print(f"{ur}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ul}".center(120))
        print(f"{li}Tutorials{li}".center(120))
        print(f"{dr}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}".center(120))
        print("")
        print("1.How to play".center(120))
        print("2.Settings".center(120))
        print("0.Back".center(120))
        print("")
        sele1 = ["1", "1."]
        sele2 = ["2", "2."]
        ...
        if selec.upper() in sele1:
            while True:
                cls()
                print("")
                print(f"{ur}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ul}".center(120))
                print(f"{li}Tutorials - how to play{li}".center(120))
                print(f"{dr}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}".center(120))
                print("")
                print("In this game main goal is to kill an enemy.".center(120))
                print("To kill enemy you need to destroi wall and have him in a hole of wall.".center(120))
                print("You can attack any par of enemy but only center of enemy have chance to do crit dmg.".center(120))
                print("You cant attack any part of enemy if before that part is a wall but you can attack".center(120))
                print("a part that dosnt have before it a wall.".center(120))
                print("")
                print("Enemy look:".center(120))
                print(f"{enemysprite[0]}".center(120))
                print(f"{enemysprite[1]}".center(120))
                print(f"{enemysprite[2]}".center(120))
                print("")
                print("0.Back".center(120))
                print("")
                back = ["0", "0.", "BACK"]
                selec = str(input("> ".rjust(118//2)))
                if selec.upper() in back:
                    break
        elif selec.upper() in sele2:
            while True:
                cls()
                print("")
                print(f"{ur}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ul}".center(120))
                print(f"{li}Tutorials - settings{li}".center(120))
                print(f"{dr}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}".center(120))
                print("")
                print("1.How to make auto laod settings".center(120))
                print("2.How to use settings.ini".center(120))
                print("3.Settings explanation".center(120))
                print("0.Back".center(120))
                print("")
                sele1 = ["1","1."]
                sele2 = ["2","2."]
                ...
                if selec.upper() in back:
                    break
                elif selec.upper() in sele1:
                    while True:
                        cls()
                        print("")
                        print("Auto Load settings".center(120))
                        print("")
                        print("To make Auto load settings you need to crate a file named settings.ini".center(120))
                        print("That file has saved settings game cannot overrite that file.".center(120))
                        print("More info what you can do in settings.ini in Tutorials>How to use settings.ini".center(120))
                        print("")
                        print("0.Back".center(120))
                        back = ["0", "0.", "BACK"]
                        selec = str(input("> ".rjust(118//2)))
                    ...
                    while True:
                        cls()
                        print("")
                        print("How to use settings.ini".center(120))
                        print("")
                        print("When you crate a file named settings.ini it need to have smt like that.".center(120))
                        print("It need to have one/all of this:".center(120))
                        print("[settings]".center(120))
                        print(" [apperance]".center(120))
                        print("  [c_apperance]".center(120))
                        print("Under each of this thing you can change difrend settings.".center(120))
                        print("All setting are explain in Tutorials>Settings explanation.".center(120))
                        print("")
                        print("0.Back".center(120))
                        back = ["0", "0.", "BACK"]
                        selec = str(input("> ".rjust(118//2)))
                    ...
                    while True:
                        cls()
                        print("")
                        print("All Settings in:".center(120))
                        print("")
                        print("1.[settings]".center(120))
                        print("2.[apperance]".center(120))
                        print("3.[c_apperance]".center(120))
                        print("0.Back".center(120))
                        sele1 = ["1","1.","SETTINGS"]
                        sele2 = ["2","2.","APPERANCE"]
                        sele3 = ["3","3.","C_APPERANCE"]
                        back = ["0", "0.", "BACK"]
                        selec = str(input("> ".rjust(118//2)))
                        if selec.upper() in back:
                            break
                            ...
                            while True:
                                ...
                                print("[settings]".center(120))
                                print("")
                                print("- animation_speed_letter_d how long is frame animation letter destroid cooldown: float".center(120))
                                print("- animation_speed_letter_r how long is frame animation letter restore cooldown: float".center(120))
                                print("")
                                print("- old_input_testers_dont_like_that is a bool variable controls input method like:".center(120))
                                print("False - input like 1a/1b etc".center(120))
                                print("True - input like first 1 after that".center(120))
                                print("clisk enter and a and clcik enter".center(120))
                                print("")
                                print("- debugingtime is 0 or 1 def 0 when 1 it diasbles cls (clear) function".center(120))
                                print("- errormsg is 0 or 1 def 0 when 1 it print error mesanges and in game cominucation".center(120))
                                print("- errorsmg_m is 0 or 1 def 0 it print more info about errors whe game".center(120))
                                print("crash or ends and it print extra informaton".center(120))
                                print("")
                                print("0.Back".center(120))
                                back = ["0", "0.", "BACK"]
                                selec = str(input("> ".rjust(118//2)))
                            ...
                            while True:
                                ...
                                print("[apperance]".center(120))
                                print("")
                                print("- boat_name is a string 3 characters will be display on boat after = shuld be one space.".center(120))
                                print("- Dmode int defines how game menu looks:".center(120))
                                print("1 - standard".center(120))
                                print("2 - symbols".center(120))
                                print("3 - custom".center(120))
                                print("- enemy_butiful int changes how enemy looks:".center(120))
                                print("1-normal 2-square 3-Tank 4-car 5-Random 6-csutom".center(120))
                                print("")
                                print("0.Back".center(120))
                                back = ["0", "0.", "BACK"]
                                selec = str(input("> ".rjust(118//2)))
                            ...
                            cls()
                            print("")
                            print("Work in progress".center(120))
                            time.sleep(0.75)
        elif selec.upper() in back:
            main_menu()
            break
...
def ResetToBasic():
    ini()
    display(Dmode)
    enemy_is_butyfil(enemy_butiful)
