...
def ship(): #game board dont make sens ik
    ...
    if dificulty == 1:
        ...
        print("|-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=|-=-=-=-|=-=-=-=-| |=-=-=-=-=-=-=-=-|")
        print("|                                                                                  ", list[0] , list2[0] , list3[0] ,list4[0], spritepos[0] ,safe_list[0],"|Gamemode: Easy  |")#16 characters
        print("|                                                                                  ", list[1] , list2[1] , list3[1] ,list4[1] , spritepos[1] ,safe_list[1],"|----------------|")
        print("|                                                                                  ", list[2] , list2[2] , list3[2] ,list4[2] , spritepos[2] ,safe_list[2],f"|Your hp: {playerhp:<7}|") 
        print("|                                                                                  ", list[3] , list2[3] , list3[3] ,list4[3] , spritepos[3] ,safe_list[3],f"|Your amo: {amutext:<6}|")#am = amunition + f string allow for less spaces in code + more control over formating
        print("|                                                                                  ", list[4] , list2[4] , list3[4] ,list4[4] , spritepos[4] ,safe_list[4],f"|Shield hp: {playershield:<5}|")
        print("|                                                                                  ", list[5] , list2[5] , list3[5] ,list4[5] , spritepos[5] ,safe_list[5],"|----------------|")
        print("|                                                                                  ", list[6] , list2[6] , list3[6] ,list4[6] , spritepos[6] ,safe_list[6],f"|Enemy hp: {curentenemyhp:<6}|")
        print("|                                                                                  ", list[7] , list2[7] , list3[7] ,list4[7] , spritepos[7] ,safe_list[7],f"|Enemy am: {enemyamunition:<6}|")#am = amunition
        print("|                                                                                  ", list[8] , list2[8] , list3[8] ,list4[8] , spritepos[8] ,safe_list[8],f"|Shield hp: {enemyshieldhp:<5}|")
        print("|                                                                                  ", list[9] , list2[9] , list3[9] ,list4[9] , spritepos[9] ,safe_list[9],"|----------------|")
        print("|                                                                                  ", list[10], list2[10], list3[10], list4[10], spritepos[10] ,safe_list[10],lastaction)
        print("|                                                                                  ", list[11], list2[11], list3[11], list4[11], spritepos[11] ,safe_list[11],"|________________|")
        print("|                                                                                  ", list[12], list2[12], list3[12], list4[12], spritepos[12] ,safe_list[12])
        print("|                                                                                  ", list[13], list2[13], list3[13], list4[13], spritepos[13] ,safe_list[13])
        print("|                                                                                  ", list[14], list2[14], list3[14], list4[14], spritepos[14] ,safe_list[14])
        print("|                                                                                  ", list[15], list2[15], list3[15], list4[15], spritepos[15] ,safe_list[15])
        print("|                                                                                  ", list[16], list2[16], list3[16], list4[16], spritepos[16] ,safe_list[16])
        print("|                                                                                  ", list[17], list2[17], list3[17], list4[17], spritepos[17] ,safe_list[17])
        print("|                                                                                  ", list[18], list2[18], list3[18], list4[18], spritepos[18] ,safe_list[18])
