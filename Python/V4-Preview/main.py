...
#clear terminal
def cls():
    debugingtime = 0 #for debuging this disable cls funcion 1 == debuging info
    if debugingtime != 1:
...
if width == -10 and height == -10:
    ...
    print("But still.")
    print("Your terminal size is difent that recomended")
    ...
    while True:
        ...
        try:
            ...
            if dificultyt.upper() in dif1:
                ...
                curentenemyhp = enemyhpnormalmax
                playershield = 4
                playerhp = int(playermaxhp*0.8) #def *0.9
                enemyamunition = 260
                enemyshieldhp = 4
                break
            else:
    ...
    if dificulty > 0 and dificulty < 6:
        try:
                                ...
                                if curentenemyhp > enemy75p: #enemy75p p stands for % 75 this number stand of hp 75% of hp
                                    ...
                                    if randomdirection == 1: #to understand hy look at def ship(): and on spritepos[]
                                        ...
                                        if Elist[0] == "S" and Elist[1] == "S" and Elist[2] == "S":
                                            ...
                                            posenemy = enemycupo-2 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[0] == "D" and Elist[1] == "D" and Elist[2] == "S" and Elist[3] == "S":
                                            posenemy = enemycupo-1 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        else:
                                            posenemy = enemycupo-3 #this is hanlding how many steps in state he can take
                                        ...
                                        Elist = enemyhardsi(3,6)# call the enemy si funcion to get list for enemy what to see hard+ will see in range to max 6up 8 down on hard: 2 up 4 down 4 becouse 2 on body 2 on down one part of body is implemented in funcion
                                        #for Elist enemy body is 3,4,5 in index
                                        if Elist[7] == "S" and Elist[6] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo+3 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[7] == "D" and Elist[6] == "S" and Elist[5] == "S" and Elist[4] == "S":
                                            posenemy = enemycupo+2 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[7] == "D" and Elist[6] == "D" and Elist[5] == "S" and Elist[4] == "S":
                                            posenemy = enemycupo+1 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        else:
                                            posenemy = enemycupo+3 #this is hanlding how many steps in state he can take
                                    ...
                                    if randomdirection == 1: #to understand hy look at def ship(): and on spritepos[]
                                        ...
                                        #for Elist enemy body is 3,4,5 in index
                                        if Elist[0] == "S" and Elist[1] == "S" and Elist[2] == "S" and Elist[3] == "S":
                                            posenemy = enemycupo-4 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[0] == "D" and Elist[1] == "S" and Elist[2] == "S" and Elist[3] == "S" and Elist[4] == "S":
                                            posenemy = enemycupo-3 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[0] == "D" and Elist[1] == "D" and Elist[2] == "S" and Elist[3] == "S" and Elist[4] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo-2 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[0] == "D" and Elist[1] == "D" and Elist[2] == "D" and Elist[3] == "S" and Elist[4] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo-1 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        else:
                                            posenemy = enemycupo-4 #this is hanlding how many steps in state he can take
                                        ...
                                        Elist = enemyhardsi(4,8)# call the enemy si funcion to get list for enemy what to see hard+ will see in range to max 6up 8 down on hard: 2 up 4 down 4 becouse 2 on body 2 on down one part of body is implemented in funcion
                                        #for Elist enemy body is 3,4,5 in index
                                        if Elist[8] == "S" and Elist[7] == "S" and Elist[6] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo+4 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[8] == "D" and Elist[7] == "S" and Elist[6] == "S" and Elist[5] == "S" and Elist[4] == "S":
                                            posenemy = enemycupo+3 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[8] == "D" and Elist[7] == "D" and Elist[6] == "S" and Elist[5] == "S" and Elist[4] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo+2 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        elif Elist[8] == "D" and Elist[7] == "D" and Elist[6] == "D" and Elist[5] == "S" and Elist[4] == "S" and Elist[5] == "S":
                                            posenemy = enemycupo+1 #this is hanlding how many steps in state he can take
                                            enemycupo = posenemy #this hanlde enemy also delete = enemy moves when he want
                                        else:
                                            posenemy = enemycupo+4 #this is hanlding how many steps in state he can take
            ...
            while True:
                ...
                print(f"{dl}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}".center(120))
                print("")
...
def ship(): #game board dont make sens ik
    ...
    if dificulty == 1:
        ...
        print(f"{li}                                                                                    ", list[0] , list2[0] , list3[0] , spritepos[0] ,safe_list[0],f"{li}Gamemode: Easy  {li}")
        print(f"{li}                                                                                    ", list[1] , list2[1] , list3[1] , spritepos[1] ,safe_list[1],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                    ", list[2] , list2[2] , list3[2] , spritepos[2] ,safe_list[2],f"{li}Your hp:  inf   {li}") 
        print(f"{li}                                                                                    ", list[3] , list2[3] , list3[3] , spritepos[3] ,safe_list[3],f"{li}Your amo: inf   {li}")#am = amunition
        print(f"{li}                                                                                    ", list[4] , list2[4] , list3[4] , spritepos[4] ,safe_list[4],f"{li}Shield hp: 0    {li}")
        print(f"{li}                                                                                    ", list[5] , list2[5] , list3[5] , spritepos[5] ,safe_list[5],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                    ", list[6] , list2[6] , list3[6] , spritepos[6] ,safe_list[6],f"{li}Enemy hp: {curentenemyhp:<6}{li}")#f  string allow for less spaces in code + more control over formating
        print(f"{li}                                                                                    ", list[7] , list2[7] , list3[7] , spritepos[7] ,safe_list[7],f"{li}Enemy amo: 0    {li}")#am = amunition
        print(f"{li}                                                                                    ", list[8] , list2[8] , list3[8] , spritepos[8] ,safe_list[8],f"{li}Shield hp: 0    {li}")
        print(f"{li}                                                                                    ", list[9] , list2[9] , list3[9] , spritepos[9] ,safe_list[9],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                    ", list[10], list2[10], list3[10], spritepos[10] ,safe_list[10],lastaction)
        print(f"{li}                                                                                    ", list[11], list2[11], list3[11], spritepos[11] ,safe_list[11],f"{dr}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}")
        print(f"{li}                                                                                    ", list[12], list2[12], list3[12], spritepos[12] ,safe_list[12])
        print(f"{li}                                                                                    ", list[13], list2[13], list3[13], spritepos[13] ,safe_list[13])
        print(f"{li}                                                                                    ", list[14], list2[14], list3[14], spritepos[14] ,safe_list[14])
        print(f"{li}                                                                                    ", list[15], list2[15], list3[15], spritepos[15] ,safe_list[15])
        print(f"{li}                                                                                    ", list[16], list2[16], list3[16], spritepos[16] ,safe_list[16])
        print(f"{li}                                                                                    ", list[17], list2[17], list3[17], spritepos[17] ,safe_list[17])
        print(f"{li}                                                                                    ", list[18], list2[18], list3[18], spritepos[18] ,safe_list[18])
        print(f"{li}                          )___(                                                     ", list[19], list2[19], list3[19], spritepos[19] ,safe_list[19])
        print(f"{li}                    _______\__\_                                                    ", list[20], list2[20], list3[20], spritepos[20] ,safe_list[20])
        print(f"{li}              ___   |===========\     ___                                           ", list[21], list2[21], list3[21], spritepos[21] ,safe_list[21])
        print(f"{li}        __   [///]__|____________\___[\\\\\]    __       ____                         ", list[22], list2[22], list3[22], spritepos[22] ,safe_list[22])
        print(f"{li}     __[//]__/                            \__[//]_____/   /                         ", list[23], list2[23], list3[23], spritepos[23] ,safe_list[23])
        print(f"{li}    |{boat_name[:3]:<3}                                                 /                          ", list[24], list2[24], list3[24], spritepos[24] ,safe_list[24])
        print(f"{li}     \__________________________________________________/                           ", list[25], list2[25], list3[25], spritepos[25] ,safe_list[25])
        ...
        print(f"{li}                                                                                  ", list[0] , list2[0] , list3[0] ,list4[0] , spritepos[0] ,safe_list[0],f"{li}Gamemode: {dificultytex:<6}{li}")#16 characters
        print(f"{li}                                                                                  ", list[1] , list2[1] , list3[1] ,list4[1] , spritepos[1] ,safe_list[1],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                  ", list[2] , list2[2] , list3[2] ,list4[2] , spritepos[2] ,safe_list[2],f"{li}Your hp: {playerhp:<7}{li}") 
        print(f"{li}                                                                                  ", list[3] , list2[3] , list3[3] ,list4[3] , spritepos[3] ,safe_list[3],f"{li}Your amo: {amutext:<6}{li}")#am = amunition + f string allow for less spaces in code + more control over formating
        print(f"{li}                                                                                  ", list[4] , list2[4] , list3[4] ,list4[4] , spritepos[4] ,safe_list[4],f"{li}Shield hp: {playershield:<5}{li}")
        print(f"{li}                                                                                  ", list[5] , list2[5] , list3[5] ,list4[5] , spritepos[5] ,safe_list[5],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                  ", list[6] , list2[6] , list3[6] ,list4[6] , spritepos[6] ,safe_list[6],f"{li}Enemy hp: {curentenemyhp:<6}{li}")
        print(f"{li}                                                                                  ", list[7] , list2[7] , list3[7] ,list4[7] , spritepos[7] ,safe_list[7],f"{li}Enemy amo: {enemyamunition:<5}{li}")#am = amunition
        print(f"{li}                                                                                  ", list[8] , list2[8] , list3[8] ,list4[8] , spritepos[8] ,safe_list[8],f"{li}Shield hp: {enemyshieldhp:<5}{li}")
        print(f"{li}                                                                                  ", list[9] , list2[9] , list3[9] ,list4[9] , spritepos[9] ,safe_list[9],f"{mr1}----------------{ml1}")
        print(f"{li}                                                                                  ", list[10], list2[10], list3[10], list4[10], spritepos[10] ,safe_list[10],lastaction)
        print(f"{li}                                                                                  ", list[11], list2[11], list3[11], list4[11], spritepos[11] ,safe_list[11],lastaction2)
        print(f"{li}                                                                                  ", list[12], list2[12], list3[12], list4[12], spritepos[12] ,safe_list[12],f"{dr}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{ud}{dl}")
        print(f"{li}                                                                                  ", list[13], list2[13], list3[13], list4[13], spritepos[13] ,safe_list[13])
        print(f"{li}                                                                                  ", list[14], list2[14], list3[14], list4[14], spritepos[14] ,safe_list[14])
        print(f"{li}                                                                                  ", list[15], list2[15], list3[15], list4[15], spritepos[15] ,safe_list[15])
        print(f"{li}                                                                                  ", list[16], list2[16], list3[16], list4[16], spritepos[16] ,safe_list[16])
        print(f"{li}                                                                                  ", list[17], list2[17], list3[17], list4[17], spritepos[17] ,safe_list[17])
        print(f"{li}                                                                                  ", list[18], list2[18], list3[18], list4[18], spritepos[18] ,safe_list[18])
        print(f"{li}                          )___(                                                   ", list[19], list2[19], list3[19], list4[19], spritepos[19] ,safe_list[19])
        print(f"{li}                    _______\__\_                                                  ", list[20], list2[20], list3[20], list4[20], spritepos[20] ,safe_list[20])
        print(f"{li}              ___   |===========\     ___                                         ", list[21], list2[21], list3[21], list4[21], spritepos[21] ,safe_list[21])
        print(f"{li}        __   [///]__|____________\___[\\\\\]    __       ____                       ", list[22], list2[22], list3[22], list3[22], spritepos[22] ,safe_list[22])
        print(f"{li}     __[//]__/                            \__[//]_____/   /                       ", list[23], list2[23], list3[23], list4[23], spritepos[23] ,safe_list[23])
        print(f"{li}    |{boat_name[:3]:<3}                                                 /                        ", list[24], list2[24], list3[24], list4[24], spritepos[24] ,safe_list[24])
        print(f"{li}     \__________________________________________________/                         ", list[25], list2[25], list3[25], list4[25], spritepos[25] ,safe_list[25])
